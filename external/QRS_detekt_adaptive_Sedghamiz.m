function [R_i,R_amp,S_i,S_amp,T_i,T_amp,Q_i,Q_amp,heart_rate,buffer_plot]=QRS_detekt_adaptive_Sedghamiz(ecg,fs,view)
%
%% function [R_i,R_amp,S_i,S_amp,T_i,T_amp]=QRS_detekt_adaptive_Sedghamiz(ecg,fs,view)
...
% function as below ;
% [R_i,R_amp,S_i,S_amp,T_i,T_amp]=QRS_detekt_adaptive_Sedghamiz(EKG1,250,10);
%
%
...
if or(~view,isempty(view)) ; return; end;
