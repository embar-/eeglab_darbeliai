function [qrs_amp_raw,qrs_i_raw,delay]=QRS_detekt_Pan_Tompkin(ecg,fs,gr)
%
%
...
%
% original filename: pan_tompkin.m v5 (2014-11-31)
% downloaded from 
...
% * 'MINPEAKDISTANCE' must be integer!
% * ecg must be double
%
%%
if ~isvector(ecg)
