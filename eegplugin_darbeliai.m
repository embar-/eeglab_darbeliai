...
uimenu( darbeliai_m, 'Label', lokaliz('Pervadinimas su info suvedimu'), ...
        ...
        [ 'try ; g.files={ALLEEG.filename} ; g.path={EEG.filepath} ; '  ...
          'save( fullfile(tempdir, ''tmp.mat'' ) , ''g'') ; ' ...
          ' catch err ; end ; ' ...
          'pop_pervadinimas ; '  ] );
...
%uimenu( darbeliai_m, 'Label', lokaliz('ERP plotas, min, max...'), ...
%        'Separator','on', 'userdata', on, 'Callback', ...
%        [ 'pop_erp_area(ALLEEG, EEG, CURRENTSET) ;'  ] );
...
uimenu( darbeliai_m, 'Label',  [ lokaliz('Apie') ' ' strrep(vers,'Darbeliai ','' ) ] , ...
          'separator','off', 'userdata', on, 'callback', ...
           'rehash ; rehash(''toolbox'') ; winopen(''Documentation.pdf'') ;'  );
else
uimenu( darbeliai_m, 'Label',  [ lokaliz('Apie') ' ' strrep(vers,'Darbeliai ','' ) ] , ...
          'separator','off', 'userdata', on, 'callback', ...
