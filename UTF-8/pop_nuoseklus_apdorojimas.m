% Nuosekliai apdoroja EEG ir saugo EEG po kiekvieno etapo akirame poaplankyje
%
...
set(handles.pushbutton9,'Enable','on');
if isempty(visi_galimi_kanalai);
    wrnmsg=[lokaliz('No names of channels found.') drb_uzklausa('papildiniai')];
    wf=warndlg(wrnmsg,lokaliz('Selection of channels'));
    uiwait(wf);
    %return;
end;
pateikiami_kanalai={};
