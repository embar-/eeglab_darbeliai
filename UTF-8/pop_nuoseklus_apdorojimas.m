    ...
    if ~isempty(EEG);
        ...
        if get(handles.checkbox_rf,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                if get(handles.checkbox_rf_,'Value') == 1 ;
                    Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                    PaskutinioIssaugotoDarboNr=DarboNr;
                    DarboPorcijaAtlikta = 1;
                    SaugomoNr = SaugomoNr +1;
        ...
        if get(handles.checkbox_atrink_kanalus1,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                disp(NaujaRinkmena);
                if get(handles.checkbox_atrink_kanalus1_,'Value') == 1 ;
                    Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                    PaskutinioIssaugotoDarboNr=DarboNr;
                    DarboPorcijaAtlikta = 1;
                    SaugomoNr = SaugomoNr +1;
        ...
        if get(handles.checkbox_filtr1,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                if get(handles.checkbox_filtr1_,'Value') == 1 ;
                    Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                    PaskutinioIssaugotoDarboNr=DarboNr;
                    DarboPorcijaAtlikta = 1;
                    SaugomoNr = SaugomoNr +1;
        ...
        if get(handles.checkbox_filtr_tinklo,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                if get(handles.checkbox_filtr_tinklo_,'Value') == 1 ;
                    Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                    PaskutinioIssaugotoDarboNr=DarboNr;
                    DarboPorcijaAtlikta = 1;
                    SaugomoNr = SaugomoNr +1;
        ...
        if get(handles.checkbox_atmesk_atkarpas_amp,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                if get(handles.checkbox_atmesk_atkarpas_amp_,'Value') == 1 ;
                    Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                    PaskutinioIssaugotoDarboNr=DarboNr;
                    DarboPorcijaAtlikta = 1;
                    SaugomoNr = SaugomoNr +1;
        ...
        if get(handles.checkbox_atmesk_atkarpas_dzn,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                if get(handles.checkbox_atmesk_atkarpas_dzn_,'Value') == 1 ;
                    Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                    PaskutinioIssaugotoDarboNr=DarboNr;
                    DarboPorcijaAtlikta = 1;
                    SaugomoNr = SaugomoNr +1;
        ...
        if get(handles.checkbox_atmesk_kan_auto,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                if get(handles.checkbox_atmesk_kan_auto_,'Value') == 1 ;
                    Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                    PaskutinioIssaugotoDarboNr=DarboNr;
                    DarboPorcijaAtlikta = 1;
                    SaugomoNr = SaugomoNr +1;
        ...
        if get(handles.checkbox_ASR,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                if get(handles.checkbox_ASR_,'Value') == 1 ;
                    Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                    PaskutinioIssaugotoDarboNr=DarboNr;
                    DarboPorcijaAtlikta = 1;
                    SaugomoNr = SaugomoNr +1;
        ...
        if get(handles.checkbox_perziureti,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                if get(handles.checkbox_perziureti_,'Value') == 1 ;
                    Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                    PaskutinioIssaugotoDarboNr=DarboNr;
                    DarboPorcijaAtlikta = 1;
                    SaugomoNr = SaugomoNr +1;
        ...
        if get(handles.checkbox_ICA,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                if get(handles.checkbox_ICA_,'Value') == 1 ;
                    Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                    PaskutinioIssaugotoDarboNr=DarboNr;
                    DarboPorcijaAtlikta = 1;
                    SaugomoNr = SaugomoNr +1;
        ...
        if get(handles.checkbox_MARA,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                if get(handles.checkbox_MARA_,'Value') == 1 ;
                    Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                    PaskutinioIssaugotoDarboNr=DarboNr;
                    DarboPorcijaAtlikta = 1;
                    SaugomoNr = SaugomoNr +1;
        ...
        if get(handles.checkbox_perziureti_ICA,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                if get(handles.checkbox_perziureti_ICA_,'Value') == 1 ;
                    Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                    PaskutinioIssaugotoDarboNr=DarboNr;
                    DarboPorcijaAtlikta = 1;
                    SaugomoNr = SaugomoNr +1;
        ...
        if get(handles.checkbox_atmesk_iki2s,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                if get(handles.checkbox_atmesk_iki2s_,'Value') == 1 ;
                    Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                    PaskutinioIssaugotoDarboNr=DarboNr;
                    DarboPorcijaAtlikta = 1;
                    SaugomoNr = SaugomoNr +1;
        ...
        if get(handles.checkbox_vienoda_trukme,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                if round(EEG.times(end)/1000*EEG.srate) ~= NORIMA_EEG_TRUKME * EEG.srate ;
                    ...
                    [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                    if get(handles.checkbox_vienoda_trukme_,'Value') == 1 ;
                        Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                        PaskutinioIssaugotoDarboNr=DarboNr;
                        DarboPorcijaAtlikta = 1;
                        SaugomoNr = SaugomoNr +1;
        ...
        if get(handles.checkbox_atrink_kanalus2,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                disp(NaujaRinkmena);
                if get(handles.checkbox_atrink_kanalus2_,'Value') == 1 ;
                    Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                    PaskutinioIssaugotoDarboNr=DarboNr;
                    DarboPorcijaAtlikta = 1;
                    SaugomoNr = SaugomoNr +1;
        ...
        if get(handles.checkbox_filtr2,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                if get(handles.checkbox_filtr2_,'Value') == 1 ;
                    Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                    PaskutinioIssaugotoDarboNr=DarboNr;
                    DarboPorcijaAtlikta = 1;
                    SaugomoNr = SaugomoNr +1;
        ...
        if get(handles.checkbox_epoch,'Value') == 1 ;
            ...
            if and(~and(get(handles.radiobutton7,'Value') == 1, DarboPorcijaAtlikta > 0), and(EEG.nbchan > 0, and(~isempty(EEG.data), EEG.pnts>1)));
                ...
                [~, NaujaRinkmena, ~ ]=fileparts(NaujaRinkmena); NaujaRinkmena=[  NaujaRinkmena Priesaga '.set'];
                if get(handles.checkbox_epoch_,'Value') == 1 ;
                    Issaugoti(ALLEEG,EEG,KELIAS_SAUGOJIMUI,Poaplankis,NaujaRinkmena);
                    PaskutinioIssaugotoDarboNr=DarboNr;
                    DarboPorcijaAtlikta = 1;
                    SaugomoNr = SaugomoNr +1;
...
Darbeliai.dialogai.pop_nuoseklus_apdorojimas.saranka(i).vardas    = vardas ;
Darbeliai.dialogai.pop_nuoseklus_apdorojimas.saranka(i).data      = datestr(now,'yyyy-mm-dd HH:MM:SS') ;
Darbeliai.dialogai.pop_nuoseklus_apdorojimas.saranka(i).komentaras= [ komentaras ' ' ] ;
Darbeliai.dialogai.pop_nuoseklus_apdorojimas.saranka(i).parinktys = Parinktys ;
