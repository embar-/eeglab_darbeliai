...
%
% (C) 2015, 2024 Mindaugas Baranauskas
...
% Darbelių konfigūracija yra Darbelių kataloge, pvz., EEGLAB/plugins/Darbeliai/Darbeliai_config.mat
% Bet jei naudotojas netyčia atnaujintų Darbelius per EEGLAB (File > Manage EEGLAB extensions),
% tuomet Darbelių kataloge esanti naudotojo konfigūracija dingsta. 
% Norint to išvengti, turėkite atsargines konfigūracijos kopijas už to katalogo ribų
