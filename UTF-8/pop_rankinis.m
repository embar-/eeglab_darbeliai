...
if get(handles.checkbox_poaplankis,'Value'); 
    NewDir=get(handles.edit_poaplankis,'String');
else
    NewDir='';
end;
...
set(handles.edit_command,'String',{ ...
   ...
   [ '% T   - ' lokaliz('selected time interval') ] ...
   [ '% E   - ' lokaliz('selected events') ] ...
   [ '% K   - ' lokaliz('names of selected channels') ] ...
   [ '% N   - ' lokaliz('irase esamu pasirinktu kanalu nr - 1') ' ' lokaliz('irase esamu pasirinktu kanalu nr - 2') ] ...
   [ '%' ] ...
...
isimintini(3).nariai={'text47' 'edit_epoch_iv' 'edit_poaplankis' 'edit_priesaga'};
