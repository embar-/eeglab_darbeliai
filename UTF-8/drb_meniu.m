...
uimenu(handles.meniu_nuostatos,'Label',lokaliz('Importuoti...'),...
...
uimenu(handles.meniu_veiksmai_eeglab, 'Accelerator','P', 'Label', lokaliz('Preview'), ...
    'callback', {@nukreipimas_i_kita_darba, handles, darbas, 'eeg_ikelk_i_eeglab', 'command', ...
    'eegplot( EEG(end).data, ''srate'', EEG(end).srate, ''eloc_file'', EEG(end).chanlocs, ''title'', EEG(end).setname, ''submean'',''on''); '  });
...
uimenu(handles.meniu_veiksmai_os, 'Label', lokaliz('Atverti ikelimo kataloga'), ...
    'callback', {@nukreipimas_gui1, handles, 'drb_meniu_veiksmai_atverti_aplanka_os', darbas, 'ivestis'}  );
uimenu(handles.meniu_veiksmai_os, 'Label', lokaliz('Atverti saugojimo kataloga'), ...
